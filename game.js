...
const STAGES = [
  ...
  },
  {
    ...
    artId: "rift",
    boss: "影蝕門將",
    objective: "追上星盤展開後出現的黑影軍團",
    storyIntro: "第一章封印解除後，星盤背面浮出第二條路線。影蝕山門的彈幕更密，開始考驗龍族養成是否跟上。",
    storyClear: "山門的黑焰被吞回星盤，龍影回廊的入口第一次亮起。",
    waves: 10,
    waveSeconds: 20,
    power: 640,
    gold: 360,
  ...
  },
  {
    ...
    artId: "valley",
    boss: "魂燈守階者",
    objective: "點亮裂階上的六盞魂燈",
    storyIntro: "裂階兩側的魂燈會吸引敵群聚集，玩家需要用吸收漩渦切出安全路線。",
    storyClear: "六盞魂燈同步燃起，照出下一段回廊的機關紋路。",
    waves: 10,
    waveSeconds: 20,
    power: 735,
    gold: 402,
  ...
  },
  {
    ...
    artId: "forge",
    boss: "熔骨鑄匠",
    objective: "擊碎工坊核心並奪回龍骨碎片",
    storyIntro: "熔骨工坊把星核碎片鍛成敵人的彈幕核心，火彈會更快、更痛。",
    storyClear: "龍骨碎片回到冒險團手中，神器的共鳴開始變得穩定。",
    waves: 10,
    waveSeconds: 20,
    power: 835,
    gold: 448,
  ...
  },
  {
    ...
    artId: "spire",
    boss: "霆針斷橋獸",
    objective: "通過會連續鎖定的霆針斷橋",
    storyIntro: "斷橋的雷針會先預警再落下，敵人彈幕也開始逼玩家連續換位。",
    storyClear: "霆針被齒輪策盤吸收，星盤指出回廊核心藏在更深處。",
    waves: 10,
    waveSeconds: 20,
    power: 940,
    gold: 498,
  ...
  },
  {
    ...
    artId: "reef",
    boss: "逆井泡潮主",
    objective: "突破逆流泡潮並回收沉沒星紋",
    storyIntro: "逆井中的泡彈又大又慢，會把安全區逐步壓縮，吞噬範圍強化在這裡很有價值。",
    storyClear: "沉沒星紋浮出水面，與星盤上的龍影路線重疊。",
    waves: 10,
    waveSeconds: 20,
    power: 1050,
    gold: 552,
  ...
  },
  {
    ...
    artId: "rift",
    boss: "月影鐘靈",
    objective: "在鐘聲改變彈道前擊破鐘廳核心",
    storyIntro: "鐘廳會讓彈幕產生偏移，追蹤、連鎖和反吐角度都需要更精準。",
    storyClear: "月影鐘聲停下，回廊深處傳來古龍王座的心跳。",
    waves: 10,
    waveSeconds: 20,
    power: 1165,
    gold: 610,
  ...
  },
  {
    ...
    artId: "spire",
    boss: "櫻霜祭司",
    objective: "保護星盤穿過櫻霜交界的祭廊",
    storyIntro: "祭廊同時出現快彈與冰晶慢彈，玩家要在閃避和吸收之間快速切換。",
    storyClear: "櫻霜祭司留下花鈴印記，十龍神器的共鳴更加完整。",
    waves: 10,
    waveSeconds: 20,
    power: 1285,
    gold: 672,
  ...
  },
  {
    ...
    artId: "forge",
    boss: "星井齒輪王",
    objective: "讓齒輪星井停止抽取龍息",
    storyIntro: "星井會抽走戰場能量，敵人出現速度加快，局內升級選擇會更影響生存。",
    storyClear: "齒輪星井停止轉動，通往王座前庭的門鎖開啟。",
    waves: 10,
    waveSeconds: 20,
    power: 1410,
    gold: 738,
  ...
  },
  {
    ...
    artId: "rift",
    boss: "古砂王庭衛",
    objective: "破解古砂王庭的吞噬封印",
    storyIntro: "王庭的封印會把彈幕拉成扇形，吸收判斷要更早做出。",
    storyClear: "吞噬封印被反吐打穿，古龍王座只剩最後一道門。",
    waves: 10,
    waveSeconds: 20,
    power: 1540,
    gold: 808,
  ...
  },
  {
    ...
    backgroundId: DEFAULT_STAGE_BACKGROUND_ID,
    boss: "吞星龍王影",
    objective: "擊敗吞星龍王影並封住第二章回廊",
    storyIntro: "王座中心的龍王影會吞回戰場能量，十波高壓彈幕後才會露出核心。",
    storyClear: "吞星龍王影被星盤封回王座，第二章的龍影回廊完成鎮壓。",
    waves: 10,
    waveSeconds: 20,
    power: 1680,
    gold: 900,
...
function renderStageGrid() {
  ...
  for (const stage of STAGES) {
    ...
    button.disabled = locked;
    button.innerHTML = `
      <span class="stage-node">${stage.id}</span>
